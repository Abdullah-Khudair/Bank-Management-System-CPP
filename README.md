...
UI Layer/          - Console screens & user interaction
Logic Layer/        - Core business logic (Bank Client, Bank User, Currency Exchange...)
Library/             - Shared utilities (validation, encryption, string helpers, Person base class)
Data File/           - Text-file based data storage
